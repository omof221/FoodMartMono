...
namespace FoodMartMono.Services.CustomerServices
{
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<List<ResultCustomerDto>> GetResultCustomerAsync()
        {
        ...
        {
            var valuew=_mapper.Map<Customer>(updateCustomerDto);
            await _customerCollection.FindOneAndReplaceAsync(x => x.CustomerId == updateCustomerDto.CustomerId, valuew);    
        }
    }
}
